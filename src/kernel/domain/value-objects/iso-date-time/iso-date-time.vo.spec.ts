...
describe("IsoDateTime", () => {
  ...
  describe("equals", () => {
    ...
    it("returns false when datetime values are different", () => {
      const left = IsoDateTime.of(validDateTime);
    ...
    it("returns false for two instants at the same UTC moment expressed differently", () => {
    ...
    it("returns false when compared against a plain string", () => {
      ...
      expect(dt.equals(validDateTime)).toBe(false);
    });
  ...
  describe("toString", () => {
    it("returns the datetime string value", () => {
      const dt = IsoDateTime.of(validDateTime);

      expect(dt.toString()).toBe(validDateTime);
    });

    it("allows String() conversion", () => {
      const dt = IsoDateTime.of(validDateTime);

      expect(String(dt)).toBe(validDateTime);
    });
  });
  ...
  describe("toJSON", () => {
    it("returns the datetime string value", () => {
      ...
      expect(dt.toJSON()).toBe(validDateTime);
    });
  ...
  describe("immutability", () => {
    it("freezes the IsoDateTime instance", () => {
      const dt = IsoDateTime.of(validDateTime);
